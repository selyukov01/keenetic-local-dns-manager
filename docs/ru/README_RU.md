...
<p>
  <bold>SELYUKOV Keenetic DNS Manager</bold> – веб-приложение для управления статическими DNS-записями интернет-центра Keenetic. Оно позволит избежать установки отдельного DNS-сервера и даст возможность комфортно управлять записями через веб-интерфейс без использования коммандной строки.
</p>
...
с устройствами Keenetic. Он не связан с компанией Keenetic, не одобрен ею и не спонсируется ею.
